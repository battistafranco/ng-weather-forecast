...
let ForecastComponent = class ForecastComponent {
    constructor(forecastService, fabService) {
...
let ForecastService = class ForecastService {
    ...
    searchForecastByCity(city) {
        return this.http.get(`${this.API_PATH}/find?q=${city}&appid=${this.APPID}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(forecast => {
            return forecast;
        }));
    }
...
//# sourceMappingURL=components-forecast-forecast-module-es2015.js.map