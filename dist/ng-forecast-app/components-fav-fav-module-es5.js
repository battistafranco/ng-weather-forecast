...
var FavComponent = /** @class */ (function () {
    function FavComponent(favService) {
    ...
    FavComponent.prototype.add = function (fav) {
        this.favService.add(fav);
    };
    FavComponent.prototype.delete = function (fav) {
        this.favService.delete(fav);
        this.close();
    };
    FavComponent.prototype.getFavs = function () {
        this.favs$ = this.favService.getAll();
        this.close();
    };
    FavComponent.prototype.update = function (fav) {
        this.favService.update(fav);
    };
    FavComponent.prototype.close = function () {
        this.selected = null;
    };
    FavComponent.prototype.select = function (fav) {
        this.selected = fav;
    };
...
//# sourceMappingURL=components-fav-fav-module-es5.js.map